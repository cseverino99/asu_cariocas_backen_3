...
//El siguiente get muestra todos los Games disponibles, con los jugadores y tableros que participan de este
router.get("games.list", "/list", async (ctx) => {
  try {
    ...
    const gamesWithPlayersAndTables = games.map(game => { // Combinar los resultados en un solo objeto
